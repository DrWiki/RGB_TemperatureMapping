...
clc
close all
disp('--------------------show region program begin (use data)--------------------')
%% 参数选择
...
%     figure
%     imshow(I);
%     title(['T = ', num2str(Tem), '°C', '(sample region)']);

    imwrite(I, ['..\pic\SampleRegion\T', num2str(Tem), '_region.jpg']);

end

disp('--------------------show region program end (use data)--------------------')